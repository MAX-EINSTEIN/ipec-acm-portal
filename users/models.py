...
class Member(models.Model):
    ...
    profile_image = models.ImageField(default="/images/profile/default_profile.png", blank=True, upload_to='images/profile/', height_field=None, width_field=None, max_length=None)
